			...
			<Card size="sm">
				...
				<CardContent>
					<div className="grid gap-2 text-xs text-muted-foreground">
						...
						<div className="flex items-center justify-between">
							<span>Started</span>
							<span className="text-foreground">{formatTimestamp(currentRun?.startedAt ?? null)}</span>
						</div>
						<div className="flex items-center justify-between">
							<span>Finished</span>
							<span className="text-foreground">{formatTimestamp(currentRun?.finishedAt ?? null)}</span>
						</div>
						<div className="flex items-center justify-between">
							<span>Duration</span>
